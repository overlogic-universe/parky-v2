...
mixin _$ParkUiModel {
 ...
 String get id; ParkStatus get status; String get lastActivityTime; String get lastActivityDay; String get studentId;
...
@override
int get hashCode => Object.hash(runtimeType,id,status,lastActivityTime,lastActivityDay,studentId);

@override
String toString() {
  return 'ParkUiModel(id: $id, status: $status, lastActivityTime: $lastActivityTime, lastActivityDay: $lastActivityDay, studentId: $studentId)';
}
...
@useResult
$Res call({
 String id, ParkStatus status, String lastActivityTime, String lastActivityDay, String studentId
});
...
/// Create a copy of ParkUiModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? status = null,Object? lastActivityTime = null,Object? lastActivityDay = null,Object? studentId = null,}) {
...
class _ParkUiModel implements ParkUiModel {
  const _ParkUiModel({required this.id, required this.status, required this.lastActivityTime, required this.lastActivityDay, required this.studentId});
...
/// Create a copy of ParkUiModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? status = null,Object? lastActivityTime = null,Object? lastActivityDay = null,Object? studentId = null,}) {
