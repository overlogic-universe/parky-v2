...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VehicleEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.plate, plate) || other.plate == plate)&&(identical(other.userId, userId) || other.userId == userId));
}
...
class _VehicleEntity implements VehicleEntity {
  const _VehicleEntity({required this.id, required this.plate, required this.userId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VehicleEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.plate, plate) || other.plate == plate)&&(identical(other.userId, userId) || other.userId == userId));
}
